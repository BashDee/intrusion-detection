...
def save_columns(columns, path):
    """Save the feature columns to disk."""
...
if __name__ == '__main__':
    ...
    X_train, X_test, y_train, y_test = preprocess_data(train_data, test_data, label_column='label')

    # One-hot encoding and feature selection are already done in preprocessing
    # Store the column names before applying SelectKBest
    ...
    # joblib.dump(selected_columns, '../models/columns.pkl')
